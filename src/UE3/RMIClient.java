...
//        Server. GET-RMIClient herausfiltern, falls POST-Requests
//        nicht benutzt werden.
// -------------------------------------------------------------


import UE2.TelephoneServer;
...
class RMIClient implements Remote {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(true) {
            ...
            // Den RMIClient lesen (Hier nur erste Zeile)
            // -------------------------------------------------------
            ...
            if(zeile.startsWith("GET /favicon")) {
                System.out.println("Favicon-RMIClient");
                br.close();
                continue;                       // Zum naechsten RMIClient
            }
            ...
            // Den RMIClient bearbeiten (Hier: nur zuruecksenden)
            // -------------------------------------------------------
            System.out.println("RMIClient wird bearbeitet");
            ...
            if (hm.get("D") != null) {
                ...
                // init RMIServer
                RMIServerInterface rmiServer = (RMIServerInterface) Naming.lookup("rmi://"+remote+"/MyTelephoneBook");

                results =  rmiServer.searchEntries(hm.get("A"), hm.get("B"));
